...
table_fields = {
    ...
    "student_research": ["rq_no","synopsis_title","supervisor_id","meeting_id","registration_number","co_supervisor_id" ],
    "meeting": ["meeting_id", "meeting_number", "date"],
    "degree_awarded": [ "rq_no", "meeting_id","registration_number"],
    "admission_canceled": [ "rq_no","meeting_id","registration_number"],
